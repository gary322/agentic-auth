...
- **Phase**: implement
- **Task**: Phase 4.5 Windows CNG/NCrypt backend
- **Status**: pending
...
1. Phase 4.5: Windows CNG/NCrypt backend.
2. Phase 4.6: Integrate keys into OAuth (DPoP) and capability PoP.
3. Phase 5.2: Build extension UI (approvals/receipts/providers/budgets).
