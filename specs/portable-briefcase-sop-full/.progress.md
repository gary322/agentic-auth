...
- **Phase**: implement
- **Task**: Phase 6.1 Pairing + request protocol (simulator)
- **Status**: pending
...
1. Phase 6.1: Define pairing + request protocol and implement simulator.
2. Phase 6.4: Mobile signer policy integration (after simulator exists).
