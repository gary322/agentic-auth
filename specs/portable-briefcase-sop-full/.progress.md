...
- **Phase**: implement
- **Task**: Phase 6.2 iOS signer app (Secure Enclave)
- **Status**: pending
...
1. Phase 6.2: Implement iOS signer app (Secure Enclave).
2. Phase 6.3: Implement Android signer app (Keystore-backed keys).
3. Phase 6.4: Mobile signer policy integration (policy knobs + e2e tests).
