...
- **Phase**: implement
- **Task**: Phase 5.3 Extension security hardening
- **Status**: pending
...
1. Phase 5.3: Extension security hardening.
2. Phase 6.1: Define pairing + request protocol and implement simulator.
3. Phase 6.4: Mobile signer policy integration (after simulator exists).
