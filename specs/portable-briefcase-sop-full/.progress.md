...
- **Phase**: implement
- **Task**: Phase 4.3 TPM2 backend (swtpm)
- **Status**: pending
...
1. Phase 4.3: TPM2 signer backend with swtpm CI.
2. Phase 4.4: Apple Keychain/Secure Enclave backend.
3. Phase 4.5: Windows CNG/NCrypt backend.
