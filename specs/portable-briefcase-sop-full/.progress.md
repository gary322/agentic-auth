...
- **Phase**: implement
- **Task**: Phase 8.1 Real L402 payment backend (LND)
- **Status**: pending
...
1. Phase 8.1: Implement L402 backend with LND (regtest).
2. Phase 8.2: Implement L402 backend with Core Lightning (optional but recommended).
3. Phase 8.3: Add Lightning regtest harness and CI job.
