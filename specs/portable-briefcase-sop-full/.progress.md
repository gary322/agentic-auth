...
- **Phase**: implement
- **Task**: Phase 9.2 VC status list verification
- **Status**: pending
...
1. Phase 9.2: VC status list verification.
2. Phase 9.3: Capability revocation profile.
3. Phase 10.1: Define AI interface and “non-authoritative” invariants.
